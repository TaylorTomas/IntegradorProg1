...
fetch(urldetalleserie)
    ...
    let infourl = `https://api.themoviedb.org/3/tv/${queryStringObjId}/watch/providers?api_key=b76faeee5fc3002a166c7f5c929c2c33`
    ...
    if (data.results.AR && data.results.AR.frustrate) {
        ...
        `<p class="Texto dondever">Donde ver:</p>`
        `<a class="Texto dondever" href="./descripcion-serie.html?=${data.id}"</a>`
